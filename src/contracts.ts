...
export function getCbContractsByChainId(chainId: number | ChainEnum) {
	if (chainId == 5) {
		...
		return {
			...
			cyberbrokersAccolades: "",
			cyberbrokersAccoladesClaim: "",
			drifterBioCanvasAddress: "0x236Fa99929915a26549871e0e49d179f41307eBf",
			drifterBioCanvasSaleAddress: "0x99138A2f3Be6e20Da2d849C8071329F97beeeF5C",
			drifterDNACardAddress: "0xf649b512D28221DA3f935403C0D6c224E9f2Fe80",
			drifterDNACardSaleAddress: "0x4ce711bb50E62E93d519C94148e940e22Aa154Eb",
